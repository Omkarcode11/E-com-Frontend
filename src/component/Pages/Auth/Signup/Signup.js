...
function Signup({ logOrSign, setLogOrSigh }) {
  ...
  function addUserDb(userData) {
    if (localStorage.getItem("rajdhaniUser")) {
      setLogOrSigh(!logOrSign);
    } else localStorage.setItem("rajdhaniUser", JSON.stringify(userData));
    setLogOrSigh(!logOrSign);
  }
  ...
  return (
    <div className="signup-layout">
      ...
      <div className="signup-form" onChange={(e) => setValues(e)}>
